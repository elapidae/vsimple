...
//=======================================================================================
TEST_F( vbyte_buffer_test, ctors )
{
...
TEST_F( vbyte_buffer_test, compare )
{
    vbyte_buffer b1{"123"};
    vbyte_buffer b2{"123"};
    vbyte_buffer b3{"12"};
...
TEST_F( vbyte_buffer_test, appends )
{
    vbyte_buffer bb;
    uint8_t u8 = 'U';
    int8_t  i8 = 'I';
...
TEST_F( vbyte_buffer_test, chops_resize )
{
...
TEST_F( vbyte_buffer_test, left_right_middle )
{
    vbyte_buffer bb{ "1234567890" };
...
TEST_F( vbyte_buffer_test, starts_ends_with )
{
    vbyte_buffer bb{ "1234567890" };
...
TEST_F( vbyte_buffer_test, splitters )
{
    //------------------------------------------------------------------
...
TEST_F( vbyte_buffer_test, append_LE_BE )
{
    char     center = 0x00;
...
TEST_F( vbyte_buffer_test, simple_view_1 )
{
...
TEST_F( vbyte_buffer_test, simple_view_omit )
{
    auto str = "1234";
    {
...
TEST_F( vbyte_buffer_test, datas )
{
    vbyte_buffer buf;
    buf.append_LE(42);
...
TEST_F( vbyte_buffer_test, pluses )
{
    vbyte_buffer b1("2+");
    vbyte_buffer b2("2=4");
...
TEST_F( vbyte_buffer_test, implicit_ctor )
{
    auto l = [](vbyte_buffer){};
...
TEST_F( vbyte_buffer_test, empty )
{
    vbyte_buffer empty;
